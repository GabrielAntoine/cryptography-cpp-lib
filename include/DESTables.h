...
constexpr std::array<uint8_t, 48> pc2Table = {
...
constexpr std::array<uint8_t, 64> initialPermutationTable = {
    58, 50, 42, 34, 26, 18, 10,  2,
...
constexpr std::array<uint8_t, 48> ebox = {
    32,  1,  2,  3,  4,  5,
     4,  5,  6,  7,  8,  9,
     8,  9, 10, 11, 12, 13,
    12, 13, 14, 15, 16, 17,
...
constexpr std::array<uint8_t, 64> finalPermutationTable = {
...
constexpr std::array<std::array<std::array<uint8_t,16>,4>,8> sboxes = {{
    // S1
    {{
...
constexpr std::array<uint8_t, 32> pbox = {
