...
namespace AES_TABLES {
    using SBOX_TYPE = std::array<std::array<uint8_t, 16>, 16>;
    using MIX_COLUMNS_MATRIX_TYPE = std::array<std::array<std::byte, 4>, 4>;

    constexpr SBOX_TYPE SBOX = {{
    ...
    constexpr MIX_COLUMNS_MATRIX_TYPE MIX_COLUMNS_MATRIX = {{
    ...
    constexpr MIX_COLUMNS_MATRIX_TYPE INV_MIX_COLUMNS_MATRIX = {{
